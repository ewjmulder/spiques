...
public class SpiquesServer {

	private static boolean shutdown = false;

    public static void startServer(final Class<?> springBootApplicationClass) {
        final String usageMessage = "Please provide the correct path to the Program Your Home property location with: -Dspiques.properties.location=/path/to/file";
        final String spiquesPropertyLocation = System.getProperty("spiques.properties.location");
        if (spiquesPropertyLocation == null) {
            System.out.println("No value provided for property 'spiques.properties.location'.");
